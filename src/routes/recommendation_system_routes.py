...
from src.services.recommendation_system_service import RecommendationSystemService, RestaurantRecommendationSystemService
...
@swag_from({
    "tags": ["Recommendations"],
    "summary": "Get restaurant recommendations for a specific user",
    "description": (
